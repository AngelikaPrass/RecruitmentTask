...
const fetchPosts = async (pageNr: number): Promise<API_PostsResponse> => {
  return axios
    .get(`https://gorest.co.in/public/v1/posts?page=${pageNr}`, {
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
        Authorization:
          "Bearer a9bf67b3b593f9fbdca800d03c42bd3c626e6d12cfba8839a66f615eeaf3cbd0",
      },
    })
    .then((response) => {
...
const fetchPostComments = async (postId: number): Promise<Comment[]> => {
  return axios
    .get(`https://gorest.co.in/public/v1/posts/${postId}/comments`, {
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
        Authorization:
